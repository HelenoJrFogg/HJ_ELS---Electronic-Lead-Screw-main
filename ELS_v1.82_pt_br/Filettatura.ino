const char FIL0[] PROGMEM = "config. passo mm";
const char FIL1[] PROGMEM = "config. passo TPI";
const char FIL2[] PROGMEM = "config. passo MOD";
const char FIL3[] PROGMEM = "desenvolvimento";
const char FIL4[] PROGMEM = "fil. a medida";
const char FIL5[] PROGMEM = "vinculo mecanico";
const char FIL6[] PROGMEM = "direita ";
const char FIL7[] PROGMEM = "esquerda";
const char FIL8[] PROGMEM = "VINCULADO";
const char FIL9[] PROGMEM = "passo: ";
const char FIL10[] PROGMEM = "SEL: bloquear";
const char FIL11[] PROGMEM = "SEL+RESET: retorna ";
const char FIL12[] PROGMEM = "SEL:iniciar  ESC:sair";
const char FIL13[] PROGMEM = "ESC:sair";
const char FIL14[] PROGMEM = "dist:";
const char FIL15[] PROGMEM = "config curso";
const char FIL16[] PROGMEM = " ** ROSCA **  ";
const char FIL17[] PROGMEM = "ajusta posicao";
