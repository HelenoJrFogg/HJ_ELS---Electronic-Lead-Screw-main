const char MP0[] PROGMEM = "* MENU  PRINCIPAL *";
const char MP1[] PROGMEM = "Configuracoes";
const char MP2[] PROGMEM = "Avanco";
const char MP3[] PROGMEM = "Rosca";
const char MP4[] PROGMEM = "Movimento Livre";
const char MP5[] PROGMEM = "Rotacao' Placa";
const char MP6[] PROGMEM = "Posicao angular";
