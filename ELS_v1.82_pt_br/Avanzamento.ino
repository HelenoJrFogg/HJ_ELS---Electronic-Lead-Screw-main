...
const char AVA0[] PROGMEM = " ** AVANCO **  ";
const char AVA1[] PROGMEM = "Long./Trasv.";
const char AVA2[] PROGMEM = "Avanco Livre";
const char AVA3[] PROGMEM = "Avanco vinculado";
const char AVA4[] PROGMEM = "Config. 'NORTON'";
const char AVA5[] PROGMEM = "Modo avanco";
const char AVA6[] PROGMEM = "***";      //Empty space for additional functions
const char AVA7[] PROGMEM = "longitudinal";
const char AVA8[] PROGMEM = "trasversal  ";
...
const char AVA15[] PROGMEM = "Posicao";
