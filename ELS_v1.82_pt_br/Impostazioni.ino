...
const char IMP2[] PROGMEM = "passos motor fuso";
const char IMP3[] PROGMEM = "passo fuso ";
const char IMP4[] PROGMEM = "rit. aceleracao";
const char IMP5[] PROGMEM = "rit. desaceleracao";
...
const char IMP15[] PROGMEM = "offset rosca";
const char IMP16[] PROGMEM = "NORTON";
const char IMP17[] PROGMEM = "Vel max stepper";
const char IMP18[] PROGMEM = "calibracao";
const char IMP19[] PROGMEM = "valores de fabrica";   //<=== FINE MENU'
...
void Impostazioni()
{
  ...
  while (stay)
  {
    ...
    {
      MenuIndex--;
      if (MenuIndex == 0) MenuIndex = 19;
      delay(300);
    } 
    if (analogRead(ANALOG_X) > HIGH_3) 
    {
      MenuIndex++;
      if (MenuIndex == 20) MenuIndex = 1;
      delay(300);
    }
    if (SEL_pressed) 
    {
